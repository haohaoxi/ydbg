...
class BaseHtml
{
    ...
    public static function span($content, $for = null, $options = [])
    {
        $options['for'] = $for;
    ...
    public static function activeSpan($model, $attribute, $options = [])
    {
        ...
        $label = ArrayHelper::remove($options, 'span', static::encode($model->getAttributeLabel($attribute)));
            //print_r(static::span($label, $for, $options));exit;
        return static::span($label, $for, $options);
    }
