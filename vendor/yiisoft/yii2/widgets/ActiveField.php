...
class ActiveField extends Component
{
    ...
    public function span($label = null, $options = [])
    {
        if ($label === false) {
            $this->parts['{span}'] = '';
            return $this;
        ...
        $options = array_merge($this->spanOptions, $options);
        if ($label !== null) {
            $options['span'] = $label;
        }

        $this->parts['{span}'] = Html::activeSpan($this->model, $this->attribute, $options);
        return $this;
    }
