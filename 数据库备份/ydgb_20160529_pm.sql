...
CREATE TABLE `dept_contact` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='机构通讯录';
...
INSERT INTO `dept_contact` VALUES ('4', '科室四', '科室四', '1', '1', null, null);
INSERT INTO `dept_contact` VALUES ('5', '科室五', '科室二', '2', '8', null, null);
INSERT INTO `dept_contact` VALUES ('6', '科室六', 'dept1', '1', '1', null, null);
...
CREATE TABLE `meet` (
  ...
  `ldsp_del` tinyint(1) DEFAULT '1' COMMENT '领导是否删除 1:否 0:是',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='会议报销申请表单';
...
CREATE TABLE `meeting` (
  ...
  `hosts` varchar(40) NOT NULL COMMENT '主持',
  `join_ren` text NOT NULL COMMENT '参加人员',
  `agenda` text,
  `arrangement` text,
  `attachment` text,
...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES ('1', 'aaaa', '0000-00-00 00:00:00', '崔俊11', 'www.baidu.com', '11111111111');
...
-- Records of study_sj
-- ----------------------------
INSERT INTO `study_sj` VALUES ('1', '111111112', '222222222', '23333', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '445555', '5566666666', '6', '77777777', '111111111111');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '崔俊11', 'X76tw5mtH2IBt818RhJglJRB26uh9SjK', '$2y$13$24ILXZNwa/y6p6NX/35X6Oube8gnZQ1fZgKnIUmRKw5P/dpBV5bQK', '0', 'admin@qq.com', '10', '1454403070', '1464501766', '1464501766', '127.0.0.1', '5', '22222', '001');
...
INSERT INTO `user` VALUES ('17', '11111', '王雪', 'IRN2bblhbv6cXr8-ceAACeGtg8r3ImIy', '$2y$13$v9Mbqso5x8.aYP4/6d1K8evwnacvuR4ViYDpJ3IchpTHOZrYwf6Wm', null, null, '10', '1464503220', '1464504033', null, '', '0', '65651', '022');
