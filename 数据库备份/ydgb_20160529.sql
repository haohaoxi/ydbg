...
-- ----------------------------
INSERT INTO `announcement` VALUES ('48', '灌灌灌灌灌', '2016-05-29 11:11:35', '崔俊11', 'D:\\xampp\\htdocs\\ydbg/backend/web/upload/tzgggl/20160529/1464491495_192.doc', '');
INSERT INTO `announcement` VALUES ('49', '222 ', '2016-05-29 11:12:43', '崔俊11', '1464491563_747.doc', '');
...
-- Records of carwx
-- ----------------------------
INSERT INTO `carwx` VALUES ('1', '', '1', '2016-05-29 10:20:22', '2016-05-29', '0', '0', '500', '0', '0', '0.00', null, null, null, null, null, null, '0.00', '13', 'xubaobao', '1', '1', '崔俊11', '2016-05-29 10:34:21', '1', null, '1', '8', '审批', '2016-05-29 10:35:05', '2', '888', '1', '8', '审批', null, '0', null, '1');
...
-- ----------------------------
INSERT INTO `dept_contact` VALUES ('1', '科室一', '机构（一）', '3', '8');
...
CREATE TABLE `kaoqin_day` (
  ...
  `worker_no` int(11) NOT NULL COMMENT '工号',
  `username` varchar(50) NOT NULL COMMENT '姓名',
  `kq_time` date NOT NULL COMMENT '考勤时间',
  `weekday` varchar(2) NOT NULL COMMENT '星期',
  `shangban_type` varchar(20) NOT NULL COMMENT '所上班制',
  `shuaka_time1` varchar(10) NOT NULL COMMENT '刷卡时1',
  `shuaka_time2` varchar(10) NOT NULL,
  `yingkq_minutes` float NOT NULL COMMENT '应出勤分钟',
  `yingkq_hours` float NOT NULL,
  `yingkq_days` float NOT NULL,
  `shicq_hours` float NOT NULL,
  `shicq_days` float NOT NULL,
  `kg_minutes` float NOT NULL COMMENT '旷工分钟',
  `qj_minutes` float NOT NULL COMMENT '请假分钟',
  `qj_hours` float NOT NULL COMMENT '请假小时',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考勤日表';
...
CREATE TABLE `kaoqin_month` (
  ...
  `worker_no` int(11) NOT NULL COMMENT '工号',
  `card_no` int(11) NOT NULL COMMENT '卡号',
  `username` varchar(50) NOT NULL COMMENT '姓名',
  `kq_time` date NOT NULL COMMENT '考勤时间',
  `ycq_hours` float NOT NULL COMMENT '应出勤小时',
  `ycq_days` float NOT NULL,
  `scq_hours` float NOT NULL COMMENT '实出勤小时',
  `scq_days` float NOT NULL,
  `kg_hours` float NOT NULL COMMENT '旷工小时',
  `kg_days` float NOT NULL,
  `total_workhours` float NOT NULL COMMENT '总计工时小时',
  `total_workdays` float NOT NULL,
  `delay_times` int(11) NOT NULL COMMENT '迟到次数',
  `zt_times` int(11) NOT NULL COMMENT '早退次数',
  `delay_minutes` float NOT NULL,
  `zt_minutes` float NOT NULL,
  `shij_days` float NOT NULL COMMENT '事假天数',
  `sick_days` float NOT NULL COMMENT '病假天数',
  `tiaoxiu_days` float NOT NULL COMMENT '调休天数',
  `gc_days` float NOT NULL COMMENT '公出天数',
  `yxnj_days` float NOT NULL COMMENT '已休年假天数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考勤月表';
...
CREATE TABLE `meet` (
  ...
  `ldsp_del` tinyint(1) DEFAULT '1' COMMENT '领导是否删除 1:否 0:是',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='会议报销申请表单';

-- ----------------------------
-- Records of meet
-- ----------------------------
INSERT INTO `meet` VALUES ('1', '1', '2016-05-29 10:20:22', '2016-05-29', '苏At729A', '二保', '500.00', '二保二保二保二保', '13', 'xubaobao', '1', '1', '崔俊11', '2016-05-29 10:34:21', '1', null, '1', '8', '审批', '2016-05-29 10:35:05', '2', '888', '1', '8', '审批', null, '0', null, '1');
...
CREATE TABLE `menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 COMMENT='菜单表';
...
INSERT INTO `role` VALUES ('13', '检察长', '0', '1', '检察长');
...
CREATE TABLE `travel` (
  ...
  `ldsp_del` tinyint(1) DEFAULT '1' COMMENT '领导是否删除 1:否 0:是',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='差旅费报销申请表单';
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '崔俊11', 'X76tw5mtH2IBt818RhJglJRB26uh9SjK', '$2y$13$24ILXZNwa/y6p6NX/35X6Oube8gnZQ1fZgKnIUmRKw5P/dpBV5bQK', '0', 'admin@qq.com', '10', '1454403070', '1464488909', '1464488909', '127.0.0.1', '5', '22222', '001');
...
-- Records of welfare
-- ----------------------------
INSERT INTO `welfare` VALUES ('0', '优秀新人奖', '辅助性福利', '2016-05-29 10:36:35', '2016-07-15 10:36:41', '1,2,3', '机构1,机构二', '福利详细福利详细福利详细福利详细', '0');
...
-- ----------------------------
INSERT INTO `welfare_apply` VALUES ('1', '1', '同意', '1', '1', null);
