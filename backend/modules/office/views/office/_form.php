...
<div class="boxer" id="boxer-zh">
    ...
    <div class="default-form baoxiao-form">
        <strong>【<?= $model->isNewRecord ? '新增':'修改' ?>办公用品】</strong>
        ...
        <span style="height: 80px"><em>*</em>适用机构</span><div class="r" style="height: 80px"><?= $form->field($model, 'office_part_name')->textInput() ?></div><br class="clr">
    ...
    <div style="width: 0px;height: 0px;display: none">
        <?= $form->field($model, 'office_part_id')->textInput()->hiddenInput();?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
