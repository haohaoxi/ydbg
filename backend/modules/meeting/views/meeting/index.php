                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            return Html::a('查看', Yii::$app->urlManager->createUrl(['/meeting/meeting/view','id'=>$model->id]), [
                                'title' => Yii::t('yii', '查看'),
                                'class' => '',
                                'data-pjax' => '0',
                            ]);
                        ...
                        'delete' => function ($url, $model, $key) {
                            ...
                            $endT=strtotime($model->end_time);
                            if($currT > $endT){
                                return Html::a('删除', Yii::$app->urlManager->createUrl(['/meeting/meeting/delete','id'=>$model->id]), [
                                    'title' => Yii::t('yii', '删除'),
