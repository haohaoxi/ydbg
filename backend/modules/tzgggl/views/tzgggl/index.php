...
/* @var $searchModel backend\modules\tzgggl\models\TzggglSearch */
...
<div class="default-table user-table">
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute'=>'title','header'=>'通告标题','headerOptions' => ['width' => '45%'],],
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'view' => function ($url, $model, $key) {
                        return Html::a('查看', Yii::$app->urlManager->createUrl(['tzgggl/tzgggl/update','id'=>$model->id , 'look_type'=>'view']), [
                            'title' => Yii::t('yii', '查看'),
                            'class' => '',
                            'data-pjax' => '0',
                        ]);
                    ...
                    'update' => function ($url, $model, $key) {
                        return Html::a('修改', Yii::$app->urlManager->createUrl(['tzgggl/tzgggl/update','id'=>$model->id , 'look'=>'update']), [
                            'title' => Yii::t('yii', '修改'),
                            'class' => '',
                            'data-pjax' => '0',
                        ]);
                    ...
                    'delete' => function ($url, $model, $key) {
                        return Html::a('删除', Yii::$app->urlManager->createUrl(['tzgggl/tzgggl/delete','id'=>$model->id]), [
                            'title' => Yii::t('yii', '删除'),
