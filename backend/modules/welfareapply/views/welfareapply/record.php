                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            if($model->welfare_apply_pack_status == '审批中'){
                                return Html::a('审批', Yii::$app->urlManager->createUrl(['welfareapply/welfareapply/sp','id'=>$model->welfare_apply_id]), [
                                    'title' => Yii::t('yii', '查看'),
                                    'data-pjax' => '0',
                                ]);
                            }else{
                                return Html::a('查看', Yii::$app->urlManager->createUrl(['welfareapply/welfareapply/spck','id'=>$model->welfare_apply_id]), [
                                    'title' => Yii::t('yii', '查看'),
                                    'data-pjax' => '0',
                                ]);
                            }
                        ...
                        'delete' => function ($url, $model, $key) {
                            if($model->welfare_apply_pack_status == '审批中'){
                                ...
                                return Html::a('删除', Yii::$app->urlManager->createUrl(['welfareapply/welfareapply/spdelete','id'=>$model->welfare_apply_id]), [
                                    'title' => Yii::t('yii', '删除'),
