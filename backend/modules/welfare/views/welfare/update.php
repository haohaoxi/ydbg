...
<div class="boxer" id="boxer-zh">
    ...
    <div class="default-form baoxiao-form">
        ...
        <br class="clr">
        <span style="height: 80px"><em>*</em>适用机构</span><div class="r" style="height: 80px"><?= $form->field($model, 'welfare_part_name')->textarea() ?></div><br class="clr">
        <span>福利明细</span><div class="r"><?= $form->field($model, 'welfare_detail')->textInput() ?></div><br class="clr">
        <?= Html::input('button','','返回', ['class' => 'btn','onclick'=>'javascript:history.go(-1);']) ?>
        <?= Html::input('submit','','存档', ['class' => 'btn']) ?>
    </div>
    <div style="width: 0px;height: 0px;display: none">
        <?= $form->field($model, 'welfare_part_id')->textInput()->hiddenInput();?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
