	...
	$.fn.lightBox = function(settings) {
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				...
				var objWidth = objImagePreloader.width;
				var objheight = objImagePreloader.height;
				if (objheight > 400) {
					objWidth = (400*objWidth)/objheight;
					objheight = 400;
				} else if(objWidth > 600) {
					objWidth = 600;
					objheight = (600*objheight)/objWidth;
				}

				_resize_container_image_box(objWidth,objheight);
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			if (intCurrentHeight > 400) {
				intCurrentWidth = (400*intCurrentWidth)/intCurrentHeight;
				intCurrentHeight = 400;
			} else if(intCurrentWidth > 600) {
				intCurrentWidth = 600;
				intCurrentHeight = (600*intCurrentHeight)/intCurrentWidth;
			}
		...
		function _resize_image() {
			...
			var img_width = $('#lightbox-image').width();
			var img_height = $('#lightbox-image').height();
			if (img_height > 400) {
				$('#lightbox-image').css("height","400px");
			} else if(img_width > 600) {
				$('#lightbox-image').css("width","600px");
			} else {
