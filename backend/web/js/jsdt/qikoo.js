...
qikoo.dialog = function() {
    ...
    var r = ['<div class="dialog-content">', "<p>" + e + "</p>", "</div>", '<div class="dialog-console clearfix_new">', '<a class="console-btn-confirm" href="#" onclick="return false;">是</a>', '<a class="console-btn-cancel" href="#" onclick="return false;">否</a>', "</div>"].join(""),
        i = qikoo.dialog.show({
            html: r
        });
